<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Lote.aspx.cs" Inherits="AppReservasSW.Views.Lote" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width:100%;">
      ...
      <%--  ID Lote  --%>
        ...
        <tr>
            <td class="auto-style6">
                <asp:Label ID="Label3" runat="server" Text="Disponibilidad"></asp:Label>
            </td>
            <td class="auto-style3">
