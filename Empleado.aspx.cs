...
namespace AppReservasSW.Views
{
    public partial class Empleado : System.Web.UI.Page
    {
        ...
        private async void InicializarControles()
        {
            ...
            IEnumerable<Models.Puesto> escogePuestos = new ObservableCollection<Models.Puesto>();
            escogePuestos = await puestoManager.ObtenerPuestos(VG.usuarioActual.CadenaToken);
            puestoList.DataSource = escogePuestos.ToList();
            puestoList.DataTextField = "PUES_NOMBRE";
            puestoList.DataValueField = "PUES_ID";
            puestoList.DataBind();
        }
        ...
        async protected void btnIngresar_Click(object sender, EventArgs e)
        {
            if (ValidarInsertar())
            {
                ...
                {
                    SED_ID = Convert.ToInt32(sedeList.SelectedValue.ToString()),
                    PUES_ID = Convert.ToInt32(puestoList.SelectedValue.ToString()),
