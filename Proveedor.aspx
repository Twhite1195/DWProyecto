<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Proveedor.aspx.cs" Inherits="AppReservasSW.Views.Proveedor" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    <asp:GridView ID="grdProveedores" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical">
    ...
    <table style="width:100%;">
      ...
      <%--  ID Proveedor  --%>
       ...
       <%-- <tr>
            ...
            <td class="auto-style3">
                <asp:TextBox ID="txtSedeId" runat="server"></asp:TextBox>
            </td>
            <td class="auto-style3"></td>
        </tr>--%>
        ...
        <tr>
            <td class="auto-style6">
                <asp:Label ID="Label4" runat="server" Text="Funcion"></asp:Label>
            </td>
